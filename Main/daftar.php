...
<head>
    ...
    <link rel="stylesheet" href="../Asset/css2/daftar.css">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="myLeftCtn"> 
                        <form class="myForm text-center" action="" method="post" id="form">
                            ...
                            <input type="submit" class="butt" value="DAFTAR" name="daftar">
                ...
                <div class="col-md-6">
                    <div class="myRightCtn">
                            <div class="box"><header>Halo yang disana!</header>
...
<!-- Memuat file jQuery terlebih dahulu -->
...
$(document).ready(function(){
    $('#form').submit(function(e){
        ...
        if(username.length < 5){
            alert("Username harus terdiri dari lebih dari 5 huruf.");
            e.preventDefault();
        }
        
        if(email.indexOf('@gmail.com') == -1){
            alert("Email harus memuat '@gmail.com'.");
            e.preventDefault();
        }
