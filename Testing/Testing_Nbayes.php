...
for ($j = 4500; $j <= 5900; $j++) {
    ...
    mysqli_query($connect, "UPDATE testing_data SET nbayes = $hout WHERE id = $j");   
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>DATA TESTING NAIVE BAYES</title>
</head>
<body>
<div class="container pt-4">
    <div class="card">
        <div class="card-header text-bg-primary text-white">DATA TESTING NAIVE BAYES</div>
        <div class="m-3">
