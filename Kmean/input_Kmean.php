    ...
    <div class="container">
        <div class="myCard">
            <div class="row">
                <div class="col-md-5">
                    <div class="myLeftCtn"> 
                        <form class="myForm text-center" action="Kmean.php" method="get">
                            <header style="color: #29008A;">KMEAN</header>
                ...
                <div class="col-md-7">
                    <div class="myRightCtn">
                            ...
                            <br> <br>
                            <p style="color:white;">Untuk dapat menggunakan fitur "Probabilitas Penjualan dengan KMEAN", pengguna harus memasukkan variabel-variabel penting dalam analisis penjualan toko, yaitu temperature, holiday flag, dan fuel price. Variabel-variabel ini akan digunakan sebagai input pada algoritma KMEAN untuk memprediksi apakah penjualan toko akan naik atau turun.</p>
